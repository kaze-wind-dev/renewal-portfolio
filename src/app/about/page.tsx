          ...
          <div className="inner">
            ...
            <ul className={clsx(styles["p-achievement__list"])}>
              <li className={clsx(styles["p-achievement__list-item"])}>
                ...
                <p className={clsx(styles["p-achievement__list-item__content"])}><span className={clsx(styles["achievement-number"])}>238</span>件</p>
                <small className={clsx(styles["p-achievement__list-item__note"])}>2025年8月末時点</small>
              ...
              <li className={clsx(styles["p-achievement__list-item"])}>
                ...
                <p className={clsx(styles["p-achievement__list-item__content"])}>
                  
                  PC<span className={clsx(styles["achievement-number"])}>90</span>以上・SP<span className={clsx(styles["achievement-number"])}>70</span>以上
                </p>
                <small className={clsx(styles["p-achievement__list-item__note"])}>PageSpeedInsightsスコア</small>
              ...
              <li className={clsx(styles["p-achievement__list-item"])}>
                ...
                <p className={clsx(styles["p-achievement__list-item__content"])}>開発期間<span className={clsx(styles["achievement-number"])}>2</span>年</p>
                <small className={clsx(styles["p-achievement__list-item__note"])}>コーダー用のツール</small>
              </li>
              <li className={clsx(styles["p-achievement__list-item"])}>
                <h3 className={clsx(styles["p-achievement__list-item__title"])}>
                  経験年数
                </h3>
                <p className={clsx(styles["p-achievement__list-item__content"])}><span className={clsx(styles["achievement-number"])}>3</span>年<span className={clsx(styles["achievement-number"])}>6</span>か月</p>
              </li>
              <li className={clsx(styles["p-achievement__list-item"])}>
                <h3 className={clsx(styles["p-achievement__list-item__title"])}>
                  マネジメント
                </h3>
                <p className={clsx(styles["p-achievement__list-item__content"])}>約<span className={clsx(styles["achievement-number"])}>6</span>か月間</p>
              </li>
              <li className={clsx(styles["p-achievement__list-item"])}>
                <h3 className={clsx(styles["p-achievement__list-item__title"])}>
                  採用・教育
                </h3>
                <p className={clsx(styles["p-achievement__list-item__content"])}><span className={clsx(styles["achievement-number"])}>2</span>回経験</p>
              </li>
            </ul>
          </div>
        </section>
              ...
              {skillsSectionItems.map((item) => {
                return (
                  ...
                  >
                    ...
                    <ul className={clsx(styles["p-skills__item-technologies"])}>
          ...
          <div className="inner">
            ...
            <dl className={clsx(styles["p-experience__list"])}>
              <div className={clsx(styles["p-experience__list-item"])}>
                ...
                <dd className={clsx(styles["p-experience__list-item__content"])}>
